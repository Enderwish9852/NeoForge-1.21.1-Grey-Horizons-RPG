...
import net.enderwish.Atmospheric_Overhaul_Subpack.core.weather.WeatherRoller;
...
public class SeasonEventHandler {
    ...
    public static void onPlayerJoin(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        // Send current season state to the joining player
        ModMessages.sendToPlayer(new SeasonSyncPacket(
                data.getTotalDays(),
                data.getYearDay(),
                data.getSeason(),
                data.getPhase(),
