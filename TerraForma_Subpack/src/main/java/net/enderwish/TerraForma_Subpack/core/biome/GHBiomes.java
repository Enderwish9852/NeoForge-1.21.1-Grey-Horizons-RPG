 ...
 *
 * getAll() added this round — a future GHBiomeSource will need to
 * enumerate every biome it can ever produce (a possibleBiomes()-style
 * override), and this is the natural single place for that list.
 */
public class GHBiomes {
    ...
    /** All 15 biome keys — for GHBiomeSource's possibleBiomes()-style override. */
